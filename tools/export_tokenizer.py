...
def main():
    parser = argparse.ArgumentParser(
        description='Export HuggingFace tokenizer.json to a compact binary format for C.'
    )
    parser.add_argument('tokenizer_json', help='Path to tokenizer.json')
    parser.add_argument('output', nargs='?', default='tokenizer.bin',
                        help='Output path for tokenizer.bin')
